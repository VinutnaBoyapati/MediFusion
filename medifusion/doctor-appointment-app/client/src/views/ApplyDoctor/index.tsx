                    ...
                    return (
                      <Form onKeyDown={onKeyDown}>
                        <Grid container rowSpacing={2} columnSpacing={4}>
                          ...
                          {/* CeDID Code field placed just below Fee Per Consultation */}
                          <Grid item xs={4}>
                            <Box sx={{ marginBottom: "10px" }}>
                              <SubHeading sx={{ marginBottom: "5px" }}>
                                License Number
                              ...
                              <PrimaryInput
                                ...
                                label=""
                                name="CeDIDcode"
                                placeholder="CeDID code"
                                value={values.CeDIDcode}
                                helperText={
                                  errors.CeDIDcode && touched.CeDIDcode
                                    ? errors.CeDIDcode
                                    : ""
                                }
                                error={
